...
results_ouput_folder<-'/media/SSD/Bioinformatics/Projects/gene_panel_generator_202108/panel_comparison_project/output/panel_comparison_analysis_2022-07-21/'
...
performance_comp_plot<-
  ...
  bind_rows(precision_comp%>%mutate(comp_type='Precision'))%>%
  bind_rows(f1_comp%>%mutate(comp_type='F1'))%>%
...
performance_comp_plot
ggsave(performance_comp_plot,file=glue('{results_ouput_folder}/performance_comparison_plot.tiff'),
       device = 'tiff',
       width = 8,height = 10,
...
distance_max_f1_vs_pa_naive_over_diseases_confidence<-
  ...
  ggplot(aes(x=name,y=value,fill=group,col=group))+
...
distance_max_f1_vs_pa_naive_over_diseases_confidence
ggsave(distance_max_f1_vs_pa_naive_over_diseases_confidence,file=glue('{results_ouput_folder}/distance_max_f1_vs_pa_naive_over_diseases_confidence.tiff'),
       device = 'tiff',
       width = 10,height = 10,
       compression = "lzw",dpi=150,bg='white')
...
percent_of_panels_plot
ggsave(percent_of_panels_plot,file=glue('{results_ouput_folder}/percent_of_panels_per_phenotype.tiff'),
       device = 'tiff',
       width = 10,height = 10,
       compression = "lzw",dpi=150,bg='white')
...
ggsave(pa_percent_of_panels_vs_panelapp_plot,file=glue('{results_ouput_folder}/percent_of_panels_per_phenotype_vs_panelapp.tiff'),
       device = 'tiff',
       width = 10,height = 10,
       compression = "lzw",dpi=150,bg='white')
...
ggsave(max_f1_performance_comparison,file=glue('{results_ouput_folder}/max_f1_performance_comparison.tiff'),
       device = 'tiff',
       width = 6,height = 6,
       compression = "lzw",dpi=150,bg='white')
...
ggsave(pr_curves_plot,file=glue('{results_ouput_folder}/pr_curves_plots_vs_pa_and_naive.tiff'),
       device = 'tiff',
       width = 10,height = 10,
       compression = "lzw",dpi=150,bg='white')
...
ggsave(pr_curves_plot,file=glue('{results_ouput_folder}/pr_curves_plots_dists.tiff'),
       device = 'tiff',
       width = 8,height = 10,
       compression = "lzw",dpi=150,bg='white')
```
